...
GLAD_PATH = /home/matheus/Documentos/TCC/realaum/include
...
.cpp:
	$(GCC) -std=c++11 -O2 -I $(OPENCV_CPP_PATH) -I $(GLAD_PATH) glad.c $< -o $@.out $(OPENCV_LIBS) -fopenmp -pthread `pkg-config --cflags --libs gstreamer-1.0`
